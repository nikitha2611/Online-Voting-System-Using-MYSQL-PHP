                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_aadhar" class="form-control input_pass" placeholder="Aadhar #" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="aadhar" class="form-control input_user" placeholder="Aadhar No" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
...
<?php 
    ...
    if(isset($_POST['sign_up_btn']))
    {
        ...
        $su_aadhar = mysqli_real_escape_string($db, $_POST['su_aadhar']);
        ...
        if($su_password == $su_retype_password)
        {
            ...
            mysqli_query($db, "INSERT INTO users(username, aadhar, password, user_role) VALUES('". $su_username ."', '". $su_aadhar ."', '". $su_password ."', '". $user_role ."')") or die(mysqli_error($db));
    ...
    }else if(isset($_POST['loginBtn']))
    {
        ...
        // Query Fetch / SELECT
        $fetchingData = mysqli_query($db, "SELECT * FROM users WHERE aadhar = '". $aadhar ."'") or die(mysqli_error($db));
        ...
        if(mysqli_num_rows($fetchingData) > 0)
        {
            ...
            if($aadhar == $data['aadhar'] AND $password == $data['password'])
            {
                session_start();
